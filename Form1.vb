...
Public Class Form1
    Dim PATH As String = "C:/Users/Marindo/Desktop/SampleFolder"
    ...
    Private Sub SaveTxt_Click(sender As Object, e As EventArgs) Handles SaveTxt.Click
        If isBlank() Then
            ...
            Status.Text = "Saved as TXT"
        Else
            Status.ForeColor = Color.Red
            Status.Text = "Complete the required fields."
        End If
    End Sub
